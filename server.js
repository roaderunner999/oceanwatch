...
app.use(express.json({ limit: '4mb' }));   // slightly larger than RipScan — video frames can be bigger
...
// API routes — respond on both /api and /oceanwatch/api for cPanel compatibility
...
if (typeof PhusionPassenger !== 'undefined') {
  ...
  app.listen(PORT, () => console.log(`\n✅  OceanWatch running on http://localhost:${PORT}\n`));
}
